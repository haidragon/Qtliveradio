...
QT_MOC_LITERAL(5, 42, 6), // "user_t"
QT_MOC_LITERAL(6, 49, 4), // "user"
QT_MOC_LITERAL(7, 54, 3), // "len"
QT_MOC_LITERAL(8, 58, 11) // "onReadyRead"

    },
    "ClientSocket\0sigWrite\0\0QTcpSocket*\0"
    "socket\0user_t\0user\0len\0onReadyRead"
};
...
void ClientSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sigWrite((*reinterpret_cast< QTcpSocket*(*)>(_a[1])),(*reinterpret_cast< user_t(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (ClientSocket::*_t)(QTcpSocket * , user_t , int );
